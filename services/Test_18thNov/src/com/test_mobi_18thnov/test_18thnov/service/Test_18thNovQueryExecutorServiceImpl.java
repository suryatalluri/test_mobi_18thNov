...
@Service
public class Test_18thNovQueryExecutorServiceImpl implements Test_18thNovQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Test_18thNovQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("Test_18thNovWMQueryExecutor")
