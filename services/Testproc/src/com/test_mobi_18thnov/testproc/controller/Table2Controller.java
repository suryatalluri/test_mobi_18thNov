...
import com.test_mobi_18thnov.testproc.service.Table2Service;
 ...
 * @see com.test_mobi_18thnov.testproc.Table2
 */

@RestController(value = "Testproc.Table2Controller")
@Api(value = "/Testproc/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/Testproc/Table2")
public class Table2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table2Controller.class);

	@Autowired
	@Qualifier("Testproc.Table2Service")
